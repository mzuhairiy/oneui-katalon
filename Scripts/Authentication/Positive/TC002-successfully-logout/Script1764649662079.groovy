...
WebUI.click(findTestObject('OneUi-MainPage/TopBar-ProfileDropD'))

WebUI.click(findTestObject('OneUi-MainPage/TopBar-SignOutBtn'))

WebUI.verifyElementVisible(findTestObject('OneUi-LoginPage/Txt-SignIn'))

def link_login = WebUI.getUrl()

assert link_login.contains('/login')
